...
abstract class Entity {
    ...
    abstract Image getSprite(SpriteLoader spriteLoader);
    ...
    abstract int getShadowX();

    abstract int getShadowY();

    abstract int getShadowHeight();

    abstract int getShadowWidth();
}
